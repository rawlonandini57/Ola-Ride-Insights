...
📂 Repository Files
📄 OLA_DATASET.csv – Raw ride dataset
...
2️⃣ Run SQL queries to extract insights – OLA_SQL-ANSWERS.png
3️⃣ Explore the Power BI dashboard insights – OLA_POWER_BI-ANSWERS.png
